...
class எழுத்தாளர்_வடிவூட்டு(object):
    @abstractmethod
    def வடிவூட்டு(தன், எழுத்தாளர்: str) -> உரை_வடிவூட்டு:
        pass


class நான்_தடிமன்_எழுத்தாளர்_வடிவூட்டு(எழுத்தாளர்_வடிவூட்டு):

    def __init__(தன், என்_பெயர்கள்: Iterable[str]):
        தன்.என்_பெயர்கள் = என்_பெயர்கள்

    def வடிவூட்டு(தன், எழுத்தாளர்):
        if எழுத்தாளர் in தன்.என்_பெயர்கள்:
            return உரை_வடிவூட்டு(தடிமன்=True)
