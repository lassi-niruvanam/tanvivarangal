...
from சுய.உருப்படி.நிறுத்தற்குறிகள் import சதுர_அடைப்பு, இடைவெளி
...
class மொழிபெயர்க்கக்கூடிய_உரை(உருப்படி):
    def __init__(தன், உரை: str, மூல்_மொழி: str, வடிவம்: உரை_வடிவம்):
        super().__init__()
        தன்.உரை = உரை
    ...
    def உருப்படிகள்(தன், மொழி: str, மொழியாக்கம்: மொழிபெயர்ப்பாளர், வடிவங்கள்: தேவையான_வடிவங்கள்) -> Iterator["உருப்படி"]:
        ...
        if மொழிபெயர்க்கப்பட்ட_உரை:
            yield உரை(
                மொழிபெயர்க்கப்பட்ட_உரை, மொழி=மொழி, வடிவம்=தன்.வடிவம்
            )
        else:
            yield உரை(
                தன்.உரை, மொழி=தன்.மூல்_மொழி, வடிவம்=தன்.வடிவம்
            )
...
class மொழிபெயர்ப்புடன்_உரை(மொழிபெயர்க்கக்கூடிய_உரை):
    def உருப்படிகள்(தன், மொழி: str, மொழியாக்கம்: மொழிபெயர்ப்பாளர், வடிவங்கள்: தேவையான_வடிவங்கள்) -> Iterator[Element]:
        உருப்படிகள் = [
            உரை(தன்.உரை, மொழி=மொழி, வடிவம்=தன்.வடிவம்)
        ]
        if மொழி != தன்.மூல்_மொழி:
            ...
            if மொழிபெயர்க்கப்பட்ட_உரை and தன்.உரை != மொழிபெயர்க்கப்பட்ட_உரை:
                ...
                உருப்படிகள் += [
                    இடைவெளி(மொழி=மொழி, வடிவம்=தன்.வடிவம்),
                    சதுர_அடைப்பு("தொடக்கம்", மொழி=மொழி, வடிவம்=தன்.வடிவம்),
                    உரை(மொழிபெயர்க்கப்பட்ட_உரை, மொழி=மொழி, வடிவம்=மொழிபெயர்ப்பின்_வடிவம்),
                    சதுர_அடைப்பு("முடிவு", மொழி=மொழி, வடிவம்=தன்.வடிவம்),
                ]
