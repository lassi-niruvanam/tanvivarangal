...
class மொழிபெயர்க்கக்கூடிய_உரை(உரை):
    def __init__(
        தன், உரை: உள்ளீடு_உரை, மூல்_சாபி: str or List[str] = None, வடிவம்: உரை_வடிவம் = None
    ):
        super().__init__(உரை=உரை.உரை, வடிவம்=வடிவம்)
    ...
    def வெளியிடு(
        ...
        if மொழிபெயர்க்கப்பட்ட_உரை:
            yield from உரை(மொழிபெயர்க்கப்பட்ட_உரை, வடிவம்=தன்.வடிவம்).வெளியிடு(
...
class மொழிபெயர்ப்புடன்_உரை(மொழிபெயர்க்கக்கூடிய_உரை):
    def வெளியிடு(
        ...
        yield from உரை(தன்.உரை, வடிவம்=தன்.வடிவம்).வெளியிடு(
            மொழி=மொழி, மொழியாக்கம்=மொழியாக்கம், வடிவங்கள்=வடிவங்கள்
        )
