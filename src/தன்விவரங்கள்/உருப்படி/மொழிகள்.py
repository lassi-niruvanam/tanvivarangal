...
class மொழிகள்(உருப்படி):
    ...
    def உருப்படிகள்(தன்) -> Iterator["உருப்படி"]:
        பத்தியின்_வடிவம் = பத்தி_வடிவம்(கீழ்_ஓரம்=0.1, உள்தள்ளல்=-0.5)
        மொழி_பட்டியல் = []
                ...
                if இ == (len(தன்.தெரிந்த_மொழிகள்) - 2):
                    மொழி_பட்டியல்.extend([
                        மொழிபெயர்க்கக்கூடிய_உரை(
                            உரை=உள்ளீடு_உரை("மற்றும்", "த"), மூல்_சாபி="மொழிகள்", வடிவம்=தன்.வடிவம்.சாய்வு()
                        ),
        ...
        yield பத்தி(
            [
                மொழிபெயர்க்கக்கூடிய_உரை(
                    உரை=உள்ளீடு_உரை(தன்.நிலை, தன்.மூல்_மொழி), மூல்_சாபி="மொழிகள்", வடிவம்=தன்.வடிவம்.சாய்வு()
                ),
                முக்கால்ப்புள்ளி(வடிவம்=தன்.வடிவம்.சாய்வு()),
                இடைவெளி(),
                *மொழி_பட்டியல்
            ],
