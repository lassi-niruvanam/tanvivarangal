...
from ..எண் import எண்
from ..கருவிகள் import எழுத்தாளர்_வடிவம், உள்ளீடு_உரை
...
class கட்டுரை(வெளியீடு):
    ...
    def வெளியீட்டின்_உருப்படிகள்(தன்) -> List["உருப்படி"]:
        ...
        தலைப்பு = மொழிபெயர்ப்புடன்_உரை(
            உரை=உள்ளீடு_உரை(தன்.தலைப்பு, தன்.வெளியீட்டின்_மொழி), மூல்_சாபி="வெளியீடு"
        )
        ...
        if len(பக்கங்கள்):
            பக்கங்கள் = [இடைவெளி(), *பக்கங்கள், முற்றுபுள்ளி()]
