...
from ..உரை import உரை
from ..எண் import எண், எண்_உரை
from ..கருவிகள் import எழுத்தாளர்_வடிவம், மொழியைக்_கண்டுப்பிடி, உள்ளீடு_உரை
...
class நூல்_அத்தியாயம்(வெளியீடு):
    ...
    def வகை_தலைப்பு(தன்) -> str:
        return "நூல் அத்தியாயங்கள்"

    def வெளியீட்டின்_உருப்படிகள்(தன்) -> List["உருப்படி"]:
        எழுத்தாளர்கள் = தன்.எழுத்தாளர்களை_வெளியிடு()

        ஆண்டு = தேதி(தன்.ஆண்டு)
        தலைப்பு = மொழிபெயர்ப்புடன்_உரை(உள்ளீடு_உரை(தன்.தலைப்பு, தன்.வெளியீட்டின்_மொழி), மூல்_சாபி="வெளியீடு")
        ...
        பத்தி_உரைகள் = [
            *எழுத்தாளர்கள்,
            ...
            முற்றுபுள்ளி(),
            இடைவெளி(),
            மொழிபெயர்க்கக்கூடிய_உரை(உள்ளீடு_உரை("இதில்:", "த"), மூல்_சாபி="வெளியீடு"),
            இடைவெளி(),
            மொழிபெயர்ப்புடன்_உரை(
                உள்ளீடு_உரை(தன்.நூல்_தலைப்பு, மொழியைக்_கண்டுப்பிடி(தன்.நூல்_தலைப்பு)),
                மூல்_சாபி="வெளியீடு",
        ...
        if தன்.வெளியீட்டாளர்:
            பத்தி_உரைகள்.extend([
                இடைவெளி(),
                மொழிபெயர்க்கக்கூடிய_உரை(உள்ளீடு_உரை("வெளியீட்டாளர்", "த"), மூல்_சாபி="வெளியீடு"),
                முக்கால்ப்புள்ளி(),
                இடைவெளி(),
                மொழிபெயர்ப்புடன்_உரை(
                    உள்ளீடு_உரை(தன்.வெளியீட்டாளர், "த"), மூல்_சாபி="வெளியீடு",
                    வடிவம்=உரை_வடிவம்(சாய்வு=True)
                ),
                முற்றுபுள்ளி(),
            ])
        ...
        if தன்.புதிப்பு:
            பத்தி_உரைகள்.extend([
                இடைவெளி(),
                மொழிபெயர்க்கக்கூடிய_உரை(உள்ளீடு_உரை("பதிப்பு", "த"), மூல்_சாபி="வெளியீடு"),
                இடைவெளி(),
        ...
        if தன்.பன்னாட்டுத்_தரப்புத்தக_எண்:
            பத்தி_உரைகள்.extend([
                இடைவெளி(),
                மொழிபெயர்க்கக்கூடிய_உரை(உள்ளீடு_உரை("பன்னாட்டுத் தரப்புத்தக எண்", "த"), மூல்_சாபி="வெளியீடு"),
                முக்கால்ப்புள்ளி(),
                இடைவெளி(),
                எண்_உரை(தன்.பன்னாட்டுத்_தரப்புத்தக_எண்),
                முற்றுபுள்ளி(),
            ])
