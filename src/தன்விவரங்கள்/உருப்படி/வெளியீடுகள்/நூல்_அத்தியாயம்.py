...
class நூல்_அத்தியாயம்(வெளியீடு):
    ...
    def வெளியீட்டின்_உருப்படிகள்(தன்) -> List["உருப்படி"]:
        ...
        தலைப்பு = மொழிபெயர்ப்புடன்_உரை(
            உள்ளீடு_உரை(தன்.தலைப்பு, தன்.வெளியீட்டின்_மொழி), மூல்_சாபி="வெளியீடு"
        )
            ...
            பத்தி_உரைகள்.extend(
                [
                    ...
                    மொழிபெயர்க்கக்கூடிய_உரை(
                        உள்ளீடு_உரை("வெளியீட்டாளர்", "த"), மூல்_சாபி="வெளியீடு"
                    ),
                    முக்கால்ப்புள்ளி(),
                    இடைவெளி(),
                    மொழிபெயர்ப்புடன்_உரை(
                        உள்ளீடு_உரை(தன்.வெளியீட்டாளர், "த"),
                        மூல்_சாபி="வெளியீடு",
                        வடிவம்=உரை_வடிவம்(சாய்வு=True),
                    ),
                    முற்றுபுள்ளி(),
        ...
        if தன்.பன்னாட்டுத்_தரப்புத்தக_எண்:
            பத்தி_உரைகள்.extend(
                [
                    இடைவெளி(),
                    மொழிபெயர்க்கக்கூடிய_உரை(
                        உள்ளீடு_உரை("பன்னாட்டுத் தரப்புத்தக எண்", "த"), மூல்_சாபி="வெளியீடு"
                    ),
                    முக்கால்ப்புள்ளி(),
                    இடைவெளி(),
        ...
        if எண்ணிம_ஆவணச்சுட்டி:
            பத்தி_உரைகள்.extend([இடைவெளி(), *எண்ணிம_ஆவணச்சுட்டி])
