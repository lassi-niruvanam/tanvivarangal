...
class மாநாடு_கட்டுரை(வெளியீடு):
    ...
    def __init__(
        ...
        தன்.ஆய்விதழ் = தகவல்கள்["booktitle"] if "booktitle" in தகவல்கள் else None

    def வெளியீட்டின்_உருப்படிகள்(தன், மொழி: str, மொழியாக்கம்: மொழிபெயர்ப்பாளர்) -> List["உருப்படி"]:
