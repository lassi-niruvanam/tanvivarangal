...
from ..உரை import உரை
from ..எண் import எண்
from ..கருவிகள் import எழுத்தாளர்_வடிவம், மொழியின்_குறியீடு, மொழியைக்_கண்டுப்பிடி, உள்ளீடு_உரை
from ..நிறுத்தற்குறிகள் import (
    அரைகால்ப்புள்ளி,
    இடைவெளி,
    இணைப்புச்சிறுகோடு,
    மூன்றுபுள்ளிகள்,
    பிரிக்க_முடியாத_இடைவெளி, முக்கால்ப்புள்ளி,
)
...
class வெளியீடு(உருப்படி, ABC):
    def __init__(தன், தகவல்கள்: dict[str, str], எழுத்தாளர்_வடிவூட்டி: எழுத்தாளர்_வடிவம் = None):
        ...
        தன்.எழுத்தாளர்கள் = (
            சுத்தமான_உரை(தகவல்கள்["author"]).split(" and ") if "author" in தகவல்கள் else []
        )
        ...
        தன்.வெளியீட்டின்_மொழி = (
            மொழியின்_குறியீடு(தகவல்கள்["language"])
            if "language" in தகவல்கள்
            else மொழியைக்_கண்டுப்பிடி(தன்.தலைப்பு)
        )

    @classmethod
    @property
    def வகை_தலைப்பு(தன்) -> str:
        return தன்.__name__
    ...
    def எழுத்தாளர்களை_வெளியிடு(தன், அதிகப்பட்ச_எழுத்தாளர்கள்=10) -> Iterable[உருப்படி]:
        ...
        for எழுத்தாளர் in இறுதியான_எழுத்தாளர்கள்:
            if len(எழுத்தாளர்கள்):
                எழுத்தாளர்கள்.extend([அரைகால்ப்புள்ளி(), இடைவெளி()])
            எழுத்தாளரின்_வடிவம் = (
                தன்.எழுத்தாளர்_வடிவூட்டி.வடிவம்(எழுத்தாளர்) if தன்.எழுத்தாளர்_வடிவூட்டி else None
            )
            எழுத்தாளர்கள்.append(உரை(எழுத்தாளர், வடிவம்=எழுத்தாளரின்_வடிவம்))
        if len(தன்.எழுத்தாளர்கள்) > அதிகப்பட்ச_எழுத்தாளர்கள்:
    ...
    def பக்கங்களை_வெளியிடு(தன்) -> List[உருப்படி]:
        if தன்.பக்கங்கள்:
            if len(தன்.பக்கங்கள்) > 1:
                பக்கங்கள் = [
                    எண்(int(தன்.பக்கங்கள்[0])),
                    இணைப்புச்சிறுகோடு(),
                    எண்(int(தன்.பக்கங்கள்[1])),
                ]
            else:
                try:
    ...
    def எண்ணிம_ஆவணச்சுட்டியை_வெளியிடு(தன்) -> List[உருப்படி]:
        if தன்.எண்ணிம_ஆவணச்சுட்டி:
            return [
                மொழிபெயர்க்கக்கூடிய_உரை(உரை=உள்ளீடு_உரை("doi", "eng"), மூல்_சாபி="வெளியீடு"),
                முக்கால்ப்புள்ளி(),
                பிரிக்க_முடியாத_இடைவெளி(),
                இணைப்பு(
                    உரை_=தன்.எண்ணிம_ஆவணச்சுட்டி,
                    இணைப்பு=f"https://doi.org/{தன்.எண்ணிம_ஆவணச்சுட்டி}",
                ),
            ]
        else:
            return []
