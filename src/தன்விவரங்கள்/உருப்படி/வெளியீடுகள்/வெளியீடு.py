...
from ..உரை import உரை
from ..எண் import எண்
from ..கருவிகள் import எழுத்தாளர்_வடிவூட்டு, மொழியின்_பெயர், மொழியைக்_கண்டுப்பிடி, உள்ளீடு_உரை
...
from ...வடிவூட்டு import பத்தி_வடிவூட்டு


class வெளியீடு(உருப்படி, ABC):
    def __init__(தன், தகவல்கள்: dict[str, str], எழுத்தாளர்_வடிவூட்டி: எழுத்தாளர்_வடிவூட்டு = None):
        super().__init__()
    ...
    def உருப்படிகள்(தன்) -> Iterator["உருப்படி"]:
        ...
        yield பத்தி(பத்தி_உரைகள், பத்தி_வடிவூட்டு(கீழ்_ஓரம்=0.25, உள்தள்ளல்=-0.5))
    ...
    def எழுத்தாளர்களை_வெளியிடு(தன், அதிகப்பட்ச_எழுத்தாளர்கள்=10) -> Iterable[உருப்படி]:
        ...
        for எழுத்தாளர் in இறுதியான_எழுத்தாளர்கள்:
            ...
            எழுத்தாளரின்_வடிவூட்டு = தன்.எழுத்தாளர்_வடிவூட்டி.வடிவூட்டு(எழுத்தாளர்) if தன்.எழுத்தாளர்_வடிவூட்டி else None
            எழுத்தாளர்கள்.append(
                உரை(
                    எழுத்தாளர்,
                    வடிவூட்டு=எழுத்தாளரின்_வடிவூட்டு
                )
            )
        if len(தன்.எழுத்தாளர்கள்) > அதிகப்பட்ச_எழுத்தாளர்கள்:
    ...
    def எண்ணிம_ஆவணச்சுட்டியை_வெளியிடு(தன்) -> List[உருப்படி]:
        if தன்.எண்ணிம_ஆவணச்சுட்டி:
            return [
                மொழிபெயர்க்கக்கூடிய_உரை(உரை=உள்ளீடு_உரை("doi:", "eng"), மூல்_சாபி="வெளியீடு"), பிரிக்க_முடியாத_இடைவெளி(),
