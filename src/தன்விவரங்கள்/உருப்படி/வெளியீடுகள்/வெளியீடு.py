...
class வெளியீடு(உருப்படி, ABC):
    ...
    def உருப்படிகள்(தன், மொழி: str, மொழியாக்கம்: மொழிபெயர்ப்பாளர்) -> Iterator["உருப்படி"]:
        பத்தி_உரைகள் = தன்.வெளியீட்டின்_உருப்படிகள்(மொழி=மொழி, மொழியாக்கம்=மொழியாக்கம்)
        yield பத்தி(பத்தி_உரைகள், பத்தி_வடிவம்(இடைவெளி=0.25, உள்தள்ளல்=-0.5))

    @abstractmethod
    def வெளியீட்டின்_உருப்படிகள்(
            தன், மொழி: str, மொழியாக்கம்: மொழிபெயர்ப்பாளர்
    ) -> List["உருப்படி"]:
        pass
