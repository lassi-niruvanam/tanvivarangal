...
from தன்விவரங்கள்.உருப்படி.மேம்ப்பட்டவை.பெயர் import பெயர்_தலைப்பு
from தன்விவரங்கள்.உருப்படி.மேம்ப்பட்டவை.மொழிகள் import மொழிகள்
from .உருப்படி import உருப்படி
from .உருப்படி.கருவிகள் import (
    எழுத்தாளர்_வடிவம்,
    நான்_தடிமன்_எழுத்தாளர்_வடிவம்,
    உள்ளீடு_உரை,
    மொழியின்_குறியீடு,
)
...
class தன்விவரங்கள்(object):
    def __init__(
            தன்,
            மூல்_மொழி: str,
            மொழிபெயர்ப்பு: Optional[மொழிபெயர்ப்பாளர்] = None,
        ...
        தன்.மொழிபெயர்ப்பாளர் = மொழிபெயர்ப்பு or ஜெஸான்_மொழிபெயர்ப்பாளர்(
            கோப்புரை=தன்.மொழிபெயர்ப்பு_கோப்புரை,
        )
    ...
    def தலைப்பு(தன், உரை: str):
        தன்.உருப்படியைச்_சேர்(தலைப்பு(உள்ளீடு_உரை(உரை, தன்.மூல்_மொழி)))

    def மொழிகள்(தன், நிலை: str, தெரிந்த_மொழிகள்: list[str], மூல்_மொழி: Optional[str] = None):
        தன்.உருப்படியைச்_சேர்(
            மொழிகள்(
                நிலை=நிலை, தெரிந்த_மொழிகள்=தெரிந்த_மொழிகள், மூல்_மொழி=மூல்_மொழி or தன்.மூல்_மொழி
            )
        )
    ...
    def வெளியீடுகள்(தன், கோப்பு: str, எழுத்தாளர்_வடிவூட்டி: எழுத்தாளர்_வடிவம் = None):
        if எழுத்தாளர்_வடிவூட்டி is None:
            try:
                என்_பெயர் = next(
                    உரு for உரு in தன்.உருப்படிகள் if isinstance(உரு, பெயர்_தலைப்பு)
                ).பெயர்
    ...
    def வெளியிடு(
            ...
            கோப்புரை=".",
            கோப்பு_பெயர்="தன்விவரங்கள்",
            லிப்ரோஃபிஸ்_கட்டளை="soffice",
    ):
        if not os.path.exists(கோப்புரை):
            os.makedirs(கோப்புரை)

        மொழி = மொழி or தன்.மூல்_மொழி
        if isinstance(மொழி, str):
            மொழி = [மொழி]
        மொழி = [மொழியின்_குறியீடு(மொ) for மொ in மொழி]

        with tempfile.TemporaryDirectory() as சமீபத்திய_கோப்புரை:
            for மொ in மொழி:
                மொழி_கோப்பு_பெயர் = f"{கோப்பு_பெயர்}_{மொ}"
                ஒடியெஃப்_ஆவணம் = தன்.ஓடியெஃப்_உருவாக்கு(மொ)
                ஒடியெஃப்_கோப்பு_முகவரி = os.path.join(
                    சமீபத்திய_கோப்புரை, f"{மொழி_கோப்பு_பெயர்}.odt"
                )
            ...
            if "pdf" in வடிவூட்டம்:
                subprocess.run(
                    [
                        ...
                        "--convert-to",
                        "pdf",
                        *[f"{கோப்பு_பெயர்}_{மொ}.odt" for மொ in மொழி],
                    ],
                    cwd=சமீபத்திய_கோப்புரை,
                )
    ...
    def மொழிபெயர்ப்பு_கோப்புகளை_உருவாக்கு(தன், வேண்டிய_மொழிகள்: list[str]):
        மொழியாக்கத்துக்காக: dict[str, dict[str, str]] = {
            மொழியின்_குறியீடு(மொழி): {} for மொழி in வேண்டிய_மொழிகள்
        }
        ...
        def மரத்திலிருந்து_அகராதி(
                மரம்: dict[str, str | dict], மூல்_சாபி: str = None
        ) -> dict[str, str]:
            அகராதி = {}
            for சாபி, மதிப்பு in மரம்.items():
                துணைசாபி = சாபி if மூல்_சாபி is None else f"{மூல்_சாபி}.{சாபி}"
                if isinstance(மதிப்பு, str):
                    அகராதி[துணைசாபி] = மதிப்பு
                else:
                    for கிளைசாபி, கிளைமதிப்பு in மரத்திலிருந்து_அகராதி(
                            மதிப்பு, மூல்_சாபி=துணைசாபி
                    ).items():
                        அகராதி[கிளைசாபி] = கிளைமதிப்பு
            return அகராதி
        ...
        def சாபிகளை_சேரு(அகராதி: dict[str, str], சாபிகள்: Iterable[str]):
            for சாபி, மதிப்பு in list(அகராதி.items()):
                if சாபி not in சாபிகள்:
                    if not மதிப்பு:
                        அகராதி.pop(சாபி)
                    elif இருக்கும்_சாபி := next(
                            (சா for சா in சாபிகள் if சா.endswith("." + சாபி.split(".")[-1])), None
                    ):
            ...
            for சாபி in list(அகராதி.keys()):
                ...
                for இ, பகுதி in enumerate(சாபி_பகுதிகள்):
                    if பகுதி not in மரம்_கிளை:
                        மரம்_கிளை[பகுதி] = (
                            அகராதி[சாபி] if இ == (len(சாபி_பகுதிகள்) - 1) else {}
                        )
            ...
            if os.path.isfile(மொழிபெயர்ப்பு_கோப்பு):
                with open(மொழிபெயர்ப்பு_கோப்பு, encoding="utf8", mode="r") as கோ:
                    try:
                        ...
                        இருக்கும்_மொழிபெயர்ப்புகளின்_அகராதி = மரத்திலிருந்து_அகராதி(
                            இருக்கும்_மொழிபெயர்ப்புகள்
                        )
                        பெயர்ப்புகள் = {**பெயர்ப்புகள், **இருக்கும்_மொழிபெயர்ப்புகளின்_அகராதி}
