...
from .உருப்படி.கருவிகள் import எழுத்தாளர்_வடிவூட்டு, நான்_தடிமன்_எழுத்தாளர்_வடிவூட்டு, உள்ளீடு_உரை
...
class தன்விவரங்கள்(object):
    ...
    def வெளியீடுகள்(தன், கோப்பு: str, எழுத்தாளர்_வடிவூட்டி: எழுத்தாளர்_வடிவூட்டு = None):
        if எழுத்தாளர்_வடிவூட்டி is None:
            ...
            எழுத்தாளர்_வடிவூட்டி = நான்_தடிமன்_எழுத்தாளர்_வடிவூட்டு([என்_பெயர்])
    ...
    def வெளியிடு(
        ...
        with tempfile.TemporaryDirectory() as சமீபத்திய_கோப்புரை:
            for மொ in மொழி:
                ...
                ஒடியெஃப்_கோப்பு_முகவரி = os.path.join(சமீபத்திய_கோப்புரை, f"{மொழி_கோப்பு_பெயர்}.odt")
                ஒடியெஃப்_ஆவணம்.save(ஒடியெஃப்_கோப்பு_முகவரி)

            if "pdf" in வடிவூட்டம்:
                subprocess.run(
                    [லிப்ரோஃபிஸ்_கட்டளை, "--convert-to", "pdf", *[f"{கோப்பு_பெயர்}_{மொ}.odt" for மொ in மொழி]],
    ...
    def ஓடியெஃப்_உருவாக்கு(தன், மொழி: str) -> Document:
        ...
        for வடிவூட்டு in வடிவங்கள்.வடிவங்கள்:
            ஆவணம்.insert_style(வடிவூட்டு)
