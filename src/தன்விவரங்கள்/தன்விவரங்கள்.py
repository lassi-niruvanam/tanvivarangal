...
from .உருப்படி.கருவிகள் import எழுத்தாளர்_வடிவம், நான்_தடிமன்_எழுத்தாளர்_வடிவம், உள்ளீடு_உரை, மொழியின்_குறியீடு
...
class தன்விவரங்கள்(object):
    ...
    def மொழிபெயர்ப்பு_கோப்புகளை_உருவாக்கு(தன், வேண்டிய_மொழிகள்: list[str]):
        மொழியாக்கத்துக்காக: dict[str, dict[str, str]] = {மொழியின்_குறியீடு(மொழி): {} for மொழி in வேண்டிய_மொழிகள்}
