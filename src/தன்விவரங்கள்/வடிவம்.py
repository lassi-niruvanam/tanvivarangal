...
class பத்தி_வடிவம்(வடிவம்):
    def __init__(தன், உள்தள்ளல்=0, ஒழுங்கு=None, கீழ்_ஓரம்=0, மேல்_ஓரம்=0, ஆரம்ப_தள்ளல்=0, இறுதி_தள்ளல்=0):
        super().__init__()
        தன்.ஒழுங்கு = ஒழுங்கு
    ...
    def சேரு(தன், வடிவம்: வடிவம்):
        if isinstance(வடிவம், உரை_வடிவம்):
            ...
            தன்.வடிவங்கள்.add(Style(
                ...
                margin_left=str((-வடிவம்.உள்தள்ளல் if வடிவம்.உள்தள்ளல் < 0 else 0) + வடிவம்.ஆரம்ப_தள்ளல்) + "cm",
            ))
        else:
