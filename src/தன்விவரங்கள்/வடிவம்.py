    ...
    def சேரு(தன், வடிவம்: வடிவம், மொழி: str):
        if isinstance(வடிவம், உரை_வடிவம்):
            ...
            if வடிவம்.ஒழுங்கு == "ஆரம்பம்":
                ஒழுங்குபடுத்தல் = "start" if மொழி_திசை_இடத்திலிருந்து else "end"
            elif வடிவம்.ஒழுங்கு == "இறுதி":
                ஒழுங்குபடுத்தல் = "end" if மொழி_திசை_இடத்திலிருந்து else "start"
            else:
                ஒழுங்குபடுத்தல் = "justify"
