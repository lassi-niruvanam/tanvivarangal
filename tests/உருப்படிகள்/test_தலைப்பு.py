...
from தன்விவரங்கள்.வடிவூட்டு import தேவையான_வடிவங்கள்
...
def test_மொழியாக்கம்_சாபிகள்():
    சாபிகள் = தலைப்பு(உள்ளீடு_உரை("கல்வி", "த")).மொழியாக்கத்துக்காக()
    assert list(சாபிகள்) == [மொழியாக்க_தகவல்(மூல்_மொழி="த", சாபி="தலைப்பு.கல்வி" , உரை="கல்வி")]


def test_மூல்_மொழி():
    என்_தலைப்பு = தலைப்பு(உள்ளீடு_உரை("கல்வி", "த"))
